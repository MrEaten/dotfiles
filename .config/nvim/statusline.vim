...
function! RedrawModeColors(mode) " {{{
  ...
  if a:mode == 'n'
    ...
    hi MyStatuslineAccentBody guibg=#608B4E gui=none guifg=#292b34
  " Insert mode
  elseif a:mode == 'i'
    hi MyStatuslineAccent guifg=#292b34 gui=none guibg=none
    hi MyStatuslineFilename guifg=#c0c0c0 gui=none guibg=#585e74
    hi MyStatuslineAccentBody guibg=#569CD6 gui=none guifg=#292b34
  " Replace mode
  elseif a:mode == 'R'
    hi MyStatuslineAccent guifg=#292b34 gui=none guibg=none
    hi MyStatuslineFilename guifg=#c0c0c0 gui=none guibg=#585e74
    hi MyStatuslineAccentBody guibg=#DCDCAA gui=none guifg=#292b34
	" Visual mode
  elseif a:mode == 'v' || a:mode == 'V' || a:mode == '^V'
    hi MyStatuslineAccent guifg=#292b34 gui=none guibg=none
    hi MyStatuslineFilename guifg=#c0c0c0 gui=none guibg=#585e74
    hi MyStatuslineAccentBody guibg=#C586C0 gui=none guifg=#292b34
  endif
...
set statusline+=%#MyStatuslineAccentBody#\ %{SetModeName(mode())}\ 
